...
def worm_song_the():
    ...
    while True:
        ...
        ma_tran[ran1[0][0]+1,ran1[0][1]+1]=3
        ma_tran[ran2[0][0]+1,ran2[0][1]+1]=5
        quy_doi_co_dien=['  ','\033[0;32m'+'[]'+'\u001b[0m','\033[0;31m'+'▒▒'+'\u001b[0m','\033[0;35m'+'██'+'\u001b[0m','\033[0;36m'+'▓▓'+'\u001b[0m','\033[0;32m'+'██'+'\u001b[0m','\033[0;33m'+'▓▓'+'\u001b[0m']
        ky_tu='║ '     
        for i in ma_tran:
            for i1 in i:
                ky_tu+=quy_doi_co_dien[int(i1)]
...
def tam_dung():
    list_dong=[' ╔══════════════════╗ ',' ║                  ║ ',' ╚══════════════════╝ ',' ║     Tiếp Tục     ║ ',' ║     Chơi Lại     ║ ',' ║      Thoát       ║ ',' ║  [  '+doi_mau_text('do','Tiếp Tục')+'  ]  ║ ',║  [  '+doi_mau_text('do','Chơi Lại')+'  ]  ║ ',' ║   [  '+doi_mau_text('do','Thoát')+'  ]    ║ ',]
    chon=0
